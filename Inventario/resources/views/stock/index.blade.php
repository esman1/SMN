                    ...
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="float-right">
                                @can('create-stock')
                                    <a href="{{ route('stock.create') }}" title="Agregar" class="btn btn-outline-success btn-sm ml-2">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="{{ route('stock.destroy', $stock->id_stock) }}" method="POST">
                                                        @can('show-stock')
                                                            <a class="btn btn-sm btn-outline-primary" href="{{ route('stock.show', $stock->id_stock) }}">
                                                                <i class="bi bi-eye"></i> {{ __('Ver') }}
                                                            </a>
                                                        @endcan
                                                        @can('edit-stock')
                                                            <a class="btn btn-sm btn-outline-warning" href="{{ route('stock.edit', $stock->id_stock) }}">
                                                        ...
                                                        @can('delete-stock')
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="button" class="btn btn-sm btn-outline-danger" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $stock->id_stock }}">
