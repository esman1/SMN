                ...
                <div class="card card-default">
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <strong class="card-title">{{ __('Editar') }} Asignación-Personal</strong>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('asigaper.update', $asigaper->id_asigaper) }}" role="form" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="Nactivo" value="{{ $asigaper->Nactivo }}" class="form-control{{ $errors->has('Nactivo') ? ' is-invalid' : '' }}" placeholder="# Activo" required>
                                @if ($errors->has('Nactivo'))
                                    <div class="invalid-feedback">{{ $errors->first('Nactivo') }}</div>
                                @endif
                            </div>
